    ...
    SubShader 
    {
        Pass 
        {
            ...
            fixed4 frag (v2f i) : COLOR
            {
                ...
                // --- DUZELTME REVİZYONU (CLAMP) ---
                // Siyah ekran yerine, kenardaki piksellerin uzamasi icin:
                // Koordinatlari 0.0 ile 1.0 arasina hapseder.
                // Ornegin uv.x 1.2 olursa, bunu 1.0 olarak isler.
                i.uv = clamp(i.uv, 0.0, 1.0);
                // ----------------------------------
